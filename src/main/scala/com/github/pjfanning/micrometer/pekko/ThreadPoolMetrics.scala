...
object ThreadPoolMetrics {
  ...
  def add(dispatcherName: String, tpe: ThreadPoolExecutor): Unit = {
    ...
    getRegistry.gauge("pekko_dispatcher_threadpoolexecutor_active_thread_count", jtags, tpe, activeCountFn)
    getRegistry.gauge("pekko_dispatcher_threadpoolexecutor_core_pool_size", jtags, tpe, corePoolSizeFn)
    getRegistry.gauge("pekko_dispatcher_threadpoolexecutor_current_pool_size", jtags, tpe, poolSizeFn)
    getRegistry.gauge("pekko_dispatcher_threadpoolexecutor_largest_pool_size", jtags, tpe, largestPoolSizeFn)
